...
{
    /**
     * on older versions of \tgseclib\File\ASN1 this would yield a PHP Warning
     * @group github275
     */
    ...
    /**
     * on older versions of \tgseclib\File\ASN1 this would produce a null instead of an array
     * @group github275
     */
        ...
        $PrincipalName = [
            ...
            'children' => [
                ...
                'name-string' => [
                    ...
                    'max' => -1,
                    'type' => ASN1::TYPE_SEQUENCE,
                    'children' => ['type' => ASN1::TYPE_IA5_STRING] // should be \tgseclib\File\ASN1::TYPE_GENERAL_STRING
                ]
            ]
        ];
    ...
    public function testMaps()
    {
        ...
        foreach ($files as $file) {
            ...
            constant('tgseclib\\File\\ASN1\\Maps\\' . basename($file, '.php') . '::MAP');
        }
    }
